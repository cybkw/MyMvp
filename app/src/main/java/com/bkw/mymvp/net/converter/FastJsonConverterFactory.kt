...
class FastJsonConverterFactory private constructor() : Converter.Factory() {
    ...
    override fun requestBodyConverter(type: Type?, parameterAnnotations: Array<Annotation>?, methodAnnotations: Array<Annotation>?, retrofit: Retrofit?): Converter<Any, RequestBody>? {
